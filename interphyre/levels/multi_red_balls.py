...
def success_condition(engine):
    ...
    # Success if green and blue balls touch (same as two_body_problem)
...
def build_level(seed=None):
    ...
    return Level(
        name="multi_red_balls",
        objects=cast(dict[str, PhyreObject], objects),
        action_objects=["red_ball1", "red_ball2"],
        success_condition=success_condition,
        metadata={
            "description": "Make the green ball touch the blue ball, with two red balls as action objects"
        },
    )
