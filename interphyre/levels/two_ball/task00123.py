...
def _create_cradle(center_x, center_y, left: bool):
    ...
    inner_base_y = center_y + 0.08 * WORLD_HEIGHT
    ...
    top_bar = Bar(
        ...
        y=center_y + 0.25 * WORLD_HEIGHT + bar_thickness / 2,
        thickness=bar_thickness,
        color="black",
        dynamic=False,
    )
...
def build_level(seed=None, variant=0, scene=None) -> Level:
    ...
    center_y = MIN_Y + rng.choice(np.linspace(0.42, 0.5, 3)) * WORLD_HEIGHT
    ...
    (
        ...
        right_center_x, center_y + 0.12 * WORLD_HEIGHT, left=False
    )
